...
/*   Updated: 2024/12/16 23:54:23 by annavm           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_vect	cam_to_world(float matrix[4][4], t_vect *v)
{
	...
	result.x = v->x * matrix[0][0] + v->y * matrix[1][0] + v->z
		* matrix[2][0] + matrix[3][0];
	result.y = v->x * matrix[0][1] + v->y * matrix[1][1] + v->z
		* matrix[2][1] + matrix[3][1];
	result.z = v->x * matrix[0][2] + v->y
		* matrix[1][2] + v->z * matrix[2][2] + matrix[3][2];
	return (result);
}
